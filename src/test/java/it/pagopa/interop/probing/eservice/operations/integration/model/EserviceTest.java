...
class EserviceTest {
	...
	@BeforeEach
	void setup() {
		eservice = Eservice.builder().state(EserviceState.INACTIVE).eserviceId(UUID.randomUUID())
	...
	void testEserviceEntity_whenDefaultValuesAreSet_returnsEservice() {
		...
		assertEquals(OffsetTime.of(23, 59, 0, 0, ZoneOffset.UTC), eserviceDuplicate.getPollingEndTime(),
				"Values should be equal");
		assertEquals(OffsetTime.of(0, 0, 0, 0, ZoneOffset.UTC), eserviceDuplicate.getPollingStartTime(),
				"Values should be equal");
	...
	void testEserviceEntity_whenDefaultValuesAreCorrectlyOverwritten_returnsEservice() {
		...
		Eservice eserviceDuplicate = testEntityManager.persistAndFlush(eservice);
		assertEquals(OffsetTime.of(1, 0, 0, 0, ZoneOffset.UTC), eserviceDuplicate.getPollingEndTime(),
				"Values should be equal");
		assertEquals(OffsetTime.of(1, 0, 0, 0, ZoneOffset.UTC), eserviceDuplicate.getPollingStartTime(),
				"Values should be equal");
	...
	void testEserviceEntity_whenGivenDuplicatedEserviceIdAndVersionId_throwsException() {
		...
		Eservice duplicateEservice = Eservice.builder().state(EserviceState.INACTIVE).eserviceId(UUID.randomUUID())
